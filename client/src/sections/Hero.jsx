...
function Hero() {
  return (
    <div className="mb-[32px]">
      <div
        className="w-full h-[400px] grid grid-cols-1  md:grid-cols-2  lg:grid-cols-3 gap-4   shadow-md   "
        ...
        <div className=" hidden   md:flex  flex-col  gap-3 ">
          <div className="w-[203px]  h-[150px] bg-[#E3F0FF]">
            <div className="flex flex-col gap-3 px-2">
              ...
              <Link
                className="bg-blue-500 text-white text-center  rounded-sm  w-[180px]  h-[30px]"
                to={"/login"}
              >
                Log in
              </Link>
              <Link
                className="bg-white  text-black w-[180px]  h-[30px] rounded-sm  text-center"
                to={"/signup"}
              >
                Sign up
              </Link>
